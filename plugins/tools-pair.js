...
async (conn, mek, m, { from, prefix, quoted, q, reply }) => {
    try {
        ...
        // Fetch pairing code
        //const fetch = require("node-fetch");
        const response = await fetch(`https://vortex-xmd-session-site.onrender.com/pair?phone=${q}`);
